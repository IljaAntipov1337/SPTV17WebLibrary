                 ...
                 <div class="col-sm-6 m-auto">
                   <div class="card">
                     <div class="card-body">
                       ...
                       <a id="btnAddBook" href="#" class="btn btn-primary w-100 rounded-pill">Add book</a>
                     </div>
                   </div>
                 </div>
              </div>`;
                          ...
                          <div class="card h-100" style="width: 18em;">
                            ...
                            <div class="card-body">
                              ...
                              <div class="card-footer d-flex justify-content-center">
                                <button id='btnToRead${books[i].id}' class="btn bg-primary text-white p-1 m-1">Familiarize</button>
                                <button id='btnToBuy${books[i].id}' class="btn bg-primary text-white p-1 m-1">Buy</button>
                              </div>
                            </div>
                          </div>
                        </div>`
